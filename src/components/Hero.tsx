...
function IconIdentite() {
  return (
    <svg viewBox="0 0 256 256" fill="currentColor" className="w-10 h-10 sm:w-12 sm:h-12">
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-5 sm:px-8 pb-14 sm:pb-16 pt-32">
        <h1
          ref={titleRef}
